...
clear
echo "Okay, you have to configure the network yourself.  This is a fairly easy task.  If you're an idiot and don't know how, this is a good guide: http://docs.solusvm.com/kvm_bridge_setup once you've done that, come back and restart this script."

files.us.tx.soluslabs.com
...
clear
ech "Thankyou for using the world's messiest script."